 ...
 */
interface RagRetrievalOptionsV1 {
    /**
 ...
 type RagErrorCodeV1 = "rag_invalid_options" | "rag_invalid_query" | "rag_unavailable" | "rag_timeout" | "rag_cancelled";
interface RagErrorV1 extends Error {
    code: RagErrorCodeV1;
}
interface RagCitationV1 {
...
interface RagRetrievalResultItemV1 {
...
interface RagRetrievalResultV1 {
 ...
 */
declare function RAG(options: RagRetrievalOptionsV1, callback: (error: RagErrorV1 | null, result: RagRetrievalResultV1 | null) => void): void;
