...
test("adds given number of days to a date", () => {
  expect(DATEADD("2012-03-04", 5)).toEqual(new Date("2012-03-09T00:00:00"))
  expect(DATEADD("2012-03-04", 10)).toEqual(new Date("2012-03-14T00:00:00"))
  expect(DATEADD("03/04/2012", 9)).toEqual(new Date("2012-03-13T00:00:00"))
})
