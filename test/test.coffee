...
describe 'GEOMETRYAREA', ->
  it 'returns the area of a polygon', ->
    GEOMETRYAREA(polygon).should.eql 82303.0337490631
      ...
      geometry: {
        ...
        coordinates: [
         [
              ...
              [ -82.47572549323576, 27.97793378491848 ],
              [ -82.47587030815419, 27.977912628698142 ],
...
describe 'GEOMETRYNEARESTPOINTONLINE', ->
  it 'returns the nearest point on a line', ->
    ...
    GEOMETRYNEARESTPOINTONLINE(lineString, point).should.eql {
      type: 'Feature',
      properties: { dist: 0.07086902780091006, index: 3, location: 1.0106398134770445, "multiFeatureIndex": 0 },
      geometry: {
        coordinates: [ -82.47458397711655, 27.976321258975698 ],
        type: 'Point'
      }
    }
