...
const android = process.env.FULCRUM_ANDROID;
const ios = process.env.FULCRUM_IOS;
const web = process.env.FULCRUM_WEB;
const site = process.env.FULCRUM_DEV_SITE;

if (!android && !ios && !web && !site) {
  console.error(`
  You must set one of:
  FULCRUM_ANDROID
  FULCRUM_IOS
...
const expressionjs = './dist/expressions.js';
